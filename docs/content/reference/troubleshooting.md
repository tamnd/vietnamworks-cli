...
Most of these come down to network reality or how vietnamworks serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

vietnamworks rate-limits like any public site. vietnamworks already paces
...
Where a surface is gated, vietnamworks reads a cookie or token you supply
...
`vietnamworks`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what vietnamworks actually did

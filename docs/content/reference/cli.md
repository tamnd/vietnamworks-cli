...
```
vietnamworks <command> [arguments] [flags]
```

Run `vietnamworks <command> --help` for the full flag list on any command. This
...
per operation you declare in `vietnamworks/domain.go`.
